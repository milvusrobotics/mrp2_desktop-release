Name:           ros-indigo-mrp2-desktop
Version:        0.2.2
Release:        0%{?dist}
Summary:        ROS mrp2_desktop package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/mrp2_desktop
Source0:        %{name}-%{version}.tar.gz

BuildArch:      noarch

Requires:       ros-indigo-mrp2-viz
...
* Mon Jan 11 2016 Akif Hacinecipoglu <akifhno@gmail.com> - 0.2.1-2
- Autogenerated by Bloom
